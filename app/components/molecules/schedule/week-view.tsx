          ...
          <div className="bg-background border border-border rounded-lg overflow-hidden">
            ...
            <div className="flex bg-muted/30 border-b border-border">
              ...
              <div className="flex flex-1 min-w-0">
                   ...
                   const dayEvents: Event[] = getters.getEventsForDay(day.getDate(), day) || [];
                      ...
                      <div className="text-center">
                        ...
                        <div
                          className={clsx(
                            ...
                            isToday && "bg-primary text-primary-foreground rounded-full w-6 h-6 sm:w-8 sm:h-8 flex items-center justify-center mx-auto",
