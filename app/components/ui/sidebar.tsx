...
function SidebarProvider({
  ...
  const setOpen = React.useCallback(
    (value: boolean | ((value: boolean) => boolean)) => {
      ...
      // biome-ignore lint/suspicious/noDocumentCookie: override
  ...
  return (
    <div className='w-full flex justify-end pr-6 pt-2'>
      <Button
        ...
        {...props}
      >
        <p className='text-white text-lg p-1 px-2 bg-black border-2 border-white rounded-xl'>
          Filters
        </p>
...
export function OriginalSidebarTrigger({
  className,
  onClick,
  ...props
}: React.ComponentProps<typeof Button>) {
