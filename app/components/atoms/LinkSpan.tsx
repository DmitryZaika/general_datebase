...
export const LinkSpan = ({ children, className, isSelected, variant = 'default', disabled = false, onClick, ...props }: IProps) => (
  <span 
    className={cn(
      ...
      variant === 'blue' && (!disabled ? "text-blue-500 hover:text-blue-600" : "text-blue-400"),
      className
    )} 
