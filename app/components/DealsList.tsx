...
export default function DealsList({
  ...
  return (
    <div className='box-border flex min-w-93 flex-1 items-start justify-start px-2 max-md:w-full max-md:shrink-0 max-md:snap-start max-md:snap-always md:min-w-65 md:flex-1 md:flex-col md:px-0 xl:max-w-120 '>
