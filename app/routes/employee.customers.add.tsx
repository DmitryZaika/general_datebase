...
export async function action({ request }: ActionFunctionArgs) {
	let user: { company_id: number; id: number };
	try {
	...
	try {
		await db.execute(
			`INSERT INTO main.customers (name, email, phone, address, company_id ) VALUES (?,?,?,?,?)`,
			[data.name, data.email, data.phone, data.address, user.company_id],
		);
	} catch (error) {
