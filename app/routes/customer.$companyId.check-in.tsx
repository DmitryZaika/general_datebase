...
const customerCheckInSchema = z.object({
	...
	safety_instructions_acknowledged: z
		...
		.refine(
			(val) => val === true,
			"You must acknowledge the safety instructions",
		),
});
		...
		<section className="mt-4 rounded-lg bg-gradient-to-br from-gray-50 to-white p-6 shadow-inner">
			...
			<ol className="list-decimal space-y-3 pl-5 text-left text-sm text-gray-700 md:text-base">
				<li>
					...
					&nbsp;If you require help lifting or moving heavy countertops or
					materials, please ask a staff member for assistance. Granite Depot is
					not responsible for any injuries obtained.
				</li>
				<li>
					<span className="font-medium">
						Avoid leaning on countertops and be cautious of sharp edges.
					</span>
					&nbsp;Display units may not be securely anchored. Avoid running your
					hands or body against these surfaces to prevent cuts or injuries.
				</li>
				<li>
					<span className="font-medium">Keep children supervised.</span>
					&nbsp;Ensure children are closely supervised while in the shop to
					prevent accidents or injuries. Do not allow them to climb on or play
					around countertops or machinery.
				</li>
				<li>
					<span className="font-medium">Stay within designated areas.</span>
					&nbsp;Customers should remain in designated customer areas and avoid
					entering restricted or work-only zones to ensure their safety.
				</li>
				<li>
					<span className="font-medium">Use caution on slippery surfaces.</span>
					&nbsp;Be mindful of potentially slippery surfaces, especially in wet
					or freshly cleaned areas. Walk slowly and carefully to avoid slips or
					falls.
				</li>
				<li>
					<span className="font-medium">Report any concerns.</span>
					&nbsp;If you notice any safety concerns or potential hazards, please
					inform a staff member immediately. Your vigilance helps maintain a
