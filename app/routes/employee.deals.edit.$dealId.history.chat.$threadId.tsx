...
export const loader = async ({ request, params }: LoaderFunctionArgs) => {
  ...
  const _customerId = customerRows?.[0]?.customer_id
...
export default function EmployeeDealsHistoryChatRoute() {
  ...
  return (
    <EmailChat
      ...
      onClose={() =>
        navigate(`/employee/deals/edit/${data.dealId}/history${location.search}`)
      }
      dealId={data.dealId}
