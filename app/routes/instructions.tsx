          ...
          <BlockList>
            <ModuleList name="After Template">
              <p className="mt-2">
                ...
                Sealer for 6 sqft - $36 Товар/услуга - кол-во sqft (если нужно)
                - сумма.
              </p>
            </ModuleList>
              ...
              <div>
                ...
                <ul className="list-disc list-inside space-y-2">
                  ...
                  <li>
                    ...
                    tell the customer the price. They can be applied during the
                    price discussion and bargaining with customers. Do not agree
                    with a lower price that the customer names right away, even
                    when it fits the above-written conditions.
                  </li>
                  <li>
        ...
        >
          <BlockList>
            <li className="mb-6">
              ...
              <ul className="list-disc list-inside mb-4 space-y-2">
                <li>
                  ➢ In case your sales per month reach $50,000 - you are getting
                  a bonus of $500
                </li>
                <li>
                  ➢ In case your sales per month reach $75,000 - you are getting
                  a bonus of $750
                </li>
                <li>
              ...
              <div className="text-lg mb-6 space-y-4">
                ...
                <p>
                  * In the event of a challenging situation or disagreement with
                  a customer, we will do an individual examination of the
            ...
            <ul className="list-none space-y-4">
              ...
              <RemnantText>
                <p>
                  ...
                  is determined by subtracting $20 from the standard price of
                  the specific color.
                </p>
              </RemnantText>
              <RemnantText>
              ...
              <RemnantText>
                <p>
                  ...
                  and must be inspected by the customer before purchase. If the
              ...
              <RemnantText>
                <p>
                  ...
                  must double-check the remnant&apos;s size to ensure it covers
                  the entire project, including backsplash.
                </p>
              </RemnantText>
            </ul>
          </div>
