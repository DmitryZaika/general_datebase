...
import { TableBody, TableCaption, TableCell, TableFooter, TableHead, TableHeader, Table, TableRow } from "~/components/ui/table";
    ...
    <Table>
      ...
      <TableHeader>
        <TableRow>
          ...
          <TableHead className="text-right text-xl">Delete Instruction</TableHead>
        </TableRow>
      </TableHeader>
      <TableBody>
        {instructions.map((instruction) => (
          <TableRow key={instruction.id}>
            ...
            <TableCell>{instruction.order}</TableCell>
